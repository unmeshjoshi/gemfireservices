...
class DerivedPositionSpec extends FunSuite with Matchers {
  ...
  test("should calculate value from balance and FX rate") {
    val position = new Position(1, "SAVING", "9952388706", "EQUITY", "CASH_EQUIVALANT", "92824", 4879, "444", 130134482, "INR", "2018-01-28")
    val fxRate = new FxRate("INR", "USD", 2, "2018-01-28")
